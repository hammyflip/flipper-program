...
pub mod flipper_program {
    ...
    pub fn payout<'info>(
        ...
        // NOTE: currently treating bets and results as binary numbers (e.g. 0 or 1)
        // instead of as bitmasks, since implementing multiple bets at once is not high pri.
...
pub struct BettorInfo {
    pub amount: u64,
    // Bitmask of coin flip predictions. Least significant bit represents the first flip. Lets multiple bets be placed at once.
    pub bets: u8,
